...
<div class="info">Для продолжения оформления заказа войдите в личный кабинет или введите свои данные в форму регистрации, если вы новый покупатель.<br/>
<?
...
<div class="register_block">
	...
	<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
		...
		<input class="register_submit" type="submit" id="reg_butt2" name="register_submit_button" value="Зарегистрироваться" <?=($_REQUEST["register_checkbox2"]=="Y"?"":"disabled")?>>
		</form>
	</div>
