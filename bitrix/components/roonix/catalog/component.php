...
/*$arrF=array("IBLOCK_ID"=>1,"CODE"=>$arResult["VARIABLES"]["ELEMENT_CODE"]);
$res = CIBlockElement::GetList(Array("SORT"=>"ASC"), $arrF);
if($ar_fields = $res->GetNext())
{
	$arrFs=array("IBLOCK_ID"=>7,"PROPERTY_CML2_LINK"=>$ar_fields["ID"]);
	$resoff = CIBlockElement::GetList(Array("SORT"=>"ASC"), $arrFs);
	if($resoff->SelectedRowsCount()>1) $componentPage="elem";
}*/
